    ...
    <>
      ...
      <CampaignList>
        {filtered?.map((campaign) => {
          // 남은 시간 계산
          const endTime = campaign.endAt ? new Date(campaign.endAt).getTime() : 0;
          const now = Date.now();
          ...
          return (
            <CampaignCard
              ...
              $isEnded={isEnded}
              onClick={() =>
                router.push(RoutePath.CampaignDetail(String(campaign.campaignId)))
              }
            >
              <CampaignImage>
