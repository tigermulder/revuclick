      ...
      <Header>
        ...
        <FormGroup>
          <Label>
            ...
            <Info>
              리뷰클릭 서비스는 네이버 아이디로만 가입 가능하며, 가입한 네이버 계정과
              캠페인 참여 계정이 동일해야 합니다.
            </Info>
          </Label>
          <Row>
            <TextFieldWrapper>
              ...
              {/* 에러 메시지 */}
              {id !== "" && !validateEmail(id) && (
                <ErrorMessage>올바른 형식의 계정이 아닙니다.</ErrorMessage>
              )}
            </TextFieldWrapper>
            <ButtonWrapper>
              <Button
              ...
              >
                {emailSent && !emailConfirmed ? "재발송" : "인증"}
              </Button>
            </ButtonWrapper>
          </Row>
            ...
            <Row>
              <TextFieldWrapper>
                ...
                {emailAuthCode !== "" && emailAuthCode.length !== 6 && (
                  <ErrorMessage>인증 코드를 입력해 주세요.</ErrorMessage>
                )}
              </TextFieldWrapper>
            </Row>
          )}
        ...
        <FormGroup>
          ...
          <TextFieldWrapper>
            ...
            {name !== "" && !validateName(name) && (
              <ErrorMessage>한글로만 입력 가능합니다.</ErrorMessage>
            )}
          </TextFieldWrapper>
        </FormGroup>
        ...
        <FormGroup>
          <Label>
            ...
            <Info>(아이디 찾기 시 필요한 정보입니다. 정확하게 입력해주세요.)</Info>
          </Label>
          <TextFieldWrapper>
            <TextField
              type="tel"
            ...
            {phone !== "" && !validatePhone(phone) && (
              <ErrorMessage>- 없이 8자리 이상의 숫자로 입력해주세요.</ErrorMessage>
            )}
          </TextFieldWrapper>
        </FormGroup>
            ...
            <CheckboxItem>
              <CheckboxWrapper>
                <Checkbox
                  ...
                  onChange={(e) => handleAgreementChange("essential1", e.target.checked)}
                />
              </CheckboxWrapper>
            </CheckboxItem>
            <CheckboxItem>
              <CheckboxWrapper>
                <Checkbox
                  ...
                  onChange={(e) => handleAgreementChange("essential2", e.target.checked)}
                />
              </CheckboxWrapper>
            </CheckboxItem>
            <CheckboxItem>
              <CheckboxWrapper>
                <Checkbox
                  ...
                  onChange={(e) => handleAgreementChange("essential3", e.target.checked)}
                />
              </CheckboxWrapper>
            </CheckboxItem>
            <CheckboxItem>
                ...
                <CheckboxItem>
                  <CheckboxWrapper>
                    <Checkbox
                      ...
                      onChange={(e) => handleAgreementChange("optional1", e.target.checked)}
                    />
                  </CheckboxWrapper>
                </CheckboxItem>
                <CheckboxItem>
                  <CheckboxWrapper>
                    <Checkbox
                      ...
                      onChange={(e) => handleAgreementChange("optional2", e.target.checked)}
                    />
                  </CheckboxWrapper>
                </CheckboxItem>
              </SubAgreementList>
              <NoticeText>
                *이메일/SMS수신에 동의하지 않으실 경우 캠페인 알림, 계정 찾기 등 관련 알림을 받아볼 수
                없습니다.
              </NoticeText>
            </CheckboxItem>
          </AgreementList>
